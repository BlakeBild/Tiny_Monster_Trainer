...
(If you're here for the most recent version of tiny monster trainer, that not on the thumby arcade yet. You just need to put Tiny_Monster_Trainer.py and the /Curtain folder on the thumby. The archive and future folders are just things I'm working on.)  
